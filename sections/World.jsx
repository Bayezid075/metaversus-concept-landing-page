  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        {/* <div className="absolute top-10 left-[20px] h-[70px] w-[70px] p-[6px] rounded-full bg-[#5d6680]">
          <img src="/insight.png" alt="people3" className="w-full h-full" />
        </div>
        <div className="absolute top-1/2 left-[45%] h-[70px] w-[70px] p-[6px] rounded-full bg-[#5d6680]">
          <img src="/insight2.png" alt="people3" className="w-full h-full" />{" "}
        </div> */}
      </motion.div>
    </motion.div>
  </section>
